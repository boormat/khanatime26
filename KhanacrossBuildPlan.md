...
- [KhanacrossRules.md](KhanacrossRules.md) — regs extract
- [KhanacrossStopwatch.md](KhanacrossStopwatch.md) — official UX detail
- [Matrix.md](Matrix.md) — comms layer
- [BluetoothDesign.md](BluetoothDesign.md) — multihop later
